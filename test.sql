...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-06-13 08:05:09
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
('03f41eb5656c333a3207d1162a6f216a', '火箭', '火箭.png', 41, 41, 8, 'West', 'Yes', '西南分区'),
('0f9012e9b12c0fff624cc91f1b865a92', '开拓者', '开拓者.png', 44, 38, 5, 'West', 'Yes', '西北分区'),
('1105d832ff07b9fa3c3c07029dc7e5dd', '老鹰', '老鹰.png', 48, 34, 4, 'East', 'Yes', '东南赛区'),
('14198c44a4c0ae65cb23a544615d9418', '太阳', '太阳.png', 23, 59, 14, 'West', 'No', '太平洋分区'),
('15fa659be1665f686f2392e01df2cb5d', '步行者', '步行者.png', 45, 37, 7, 'East', 'Yes', '中央分区'),
('1f9622d54781f79da17bbd9ab829bbf0', '骑士', '骑士.png', 57, 25, 1, 'East', 'Yes', '中央分区'),
('2a16e44488057252586bee891dd60a6c', '鹈鹕', '鹈鹕.png', 30, 52, 12, 'West', 'No', '西南分区'),
('39c8525ef9950e3d31311ead05b2196a', '湖人', '湖人.png', 17, 65, 15, 'West', 'No', '太平洋分区'),
('438aa85c262d5ed16aeebf55a3b49574', '马刺', '马刺.png', 67, 15, 2, 'West', 'Yes', '西南分区'),
('5ece5d1703dd23e46b9ba1a1a6fb7edf', '小牛', '小牛.png', 42, 40, 6, 'West', 'Yes', '西南分区'),
('63660380f76cba4bef9f08fdb68445fe', '凯尔特人', '凯尔特人.png', 48, 34, 5, 'East', 'Yes', '大西洋分区'),
('7889e2e347cba5dbfb5b8f615e8b7209', '活塞', '活塞.png', 44, 38, 8, 'East', 'Yes', '中央分区'),
('7b0e0e46cd203d8043174e97b3336681', '爵士', '爵士.png', 40, 42, 9, 'West', 'No', '西北分区'),
('7e262289673080882f92bfb4a4f8c309', '篮网', '篮网.png', 21, 61, 14, 'East', 'No', '大西洋分区'),
('963fcdce80501dd1be79dee4d83d23b7', '快船', '快船.png', 53, 29, 4, 'West', 'Yes', '太平洋分区'),
('a3d282dd57a637d2b292e08fde3b8cea', '雷霆', '雷霆.png', 55, 27, 3, 'West', 'Yes', '西北分区'),
('a5d6c0e5943b6c409f038e73d3df595e', '热火', '热火.png', 48, 34, 3, 'East', 'Yes', '东南赛区'),
('a7474523e11a1ee64c0c808048e61bfd', '掘金', '掘金.png', 33, 49, 11, 'West', 'No', '西北分区'),
('a771dd1003f325fa80dbac21f518e438', '猛龙', '猛龙.png', 56, 26, 2, 'East', 'Yes', '大西洋分区'),
('acf31c6d43451da2a753bf550d4e125e', '76人', '76人.png', 10, 72, 15, 'East', 'No', '大西洋分区'),
('b20621f8a81b35d33701ab634709481a', '雄鹿', '雄鹿.png', 33, 49, 12, 'East', 'No', '中央分区'),
('b795a48212464260fd94138174d749a0', '森林狼', '森林狼.png', 29, 53, 13, 'West', 'No', '西北分区'),
('c784472058f3f0b8c0ffc9385fc247fe', '魔术', '魔术.png', 35, 47, 11, 'East', 'No', '东南赛区'),
('c90ef405c1e540d213999af012127f8f', '灰熊', '灰熊.png', 42, 40, 7, 'West', 'Yes', '西南分区'),
('d02a28337be26724db783f4cb66ca23d', '尼克斯', '尼克斯.png', 32, 50, 13, 'East', 'No', '大西洋分区'),
('d59e834193bbb634b2c5d32f5205dba0', '国王', '国王.png', 33, 49, 10, 'West', 'No', '太平洋分区'),
('f2af3e9ec9df65a7fbfae0f876bc67a6', '公牛', '公牛.png', 42, 40, 9, 'East', 'No', '中央分区'),
('fb8016c73ccf4d34d6286f4e59769733', '奇才', '奇才.png', 41, 41, 10, 'East', 'No', '东南赛区'),
('fc6cff760a43730060c1601ef1fb41c8', '勇士', '勇士.png', 73, 9, 1, 'West', 'Yes', '太平洋分区'),
('fd07a063b7dca5be1e0b2efb4a839c3b', '黄蜂', '黄蜂.png', 48, 34, 6, 'East', 'Yes', '东南赛区');
